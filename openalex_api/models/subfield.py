...
class Subfield(BaseModel):
    ...
    topics: conlist(SubfieldTopicsInner) = Field(...)
    ...
    def from_dict(cls, obj: dict) -> Subfield:
        ...
        _obj = Subfield.parse_obj({
            ...
            "topics": [SubfieldTopicsInner.from_dict(_item) for _item in obj.get("topics")] if obj.get("topics") is not None else None,
