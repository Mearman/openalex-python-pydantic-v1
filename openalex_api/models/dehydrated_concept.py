...
class DehydratedConcept(BaseModel):
    ...
    __properties = ["display_name", "id", "level", "score", "wikidata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DehydratedConcept:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DehydratedConcept:
        """Create an instance of DehydratedConcept from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DehydratedConcept.parse_obj(obj)

        _obj = DehydratedConcept.parse_obj({
