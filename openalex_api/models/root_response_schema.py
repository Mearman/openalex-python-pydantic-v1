...
class RootResponseSchema(BaseModel):
    ...
    RootResponseSchema
    """
    documentation_url: Optional[Any] = Field(...)
    msg: Optional[Any] = Field(...)
    version: Optional[Any] = Field(...)
    __properties = ["documentation_url", "msg", "version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RootResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RootResponseSchema:
        """Create an instance of RootResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RootResponseSchema.parse_obj(obj)

        _obj = RootResponseSchema.parse_obj({
