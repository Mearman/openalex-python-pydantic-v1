...
class Apc(BaseModel):
    ...
    value_usd: Optional[Any] = Field(...)
    __properties = ["currency", "provenance", "value", "value_usd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Apc:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.value_usd is None and "value_usd" in self.__fields_set__:
            _dict['value_usd'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> Apc:
        """Create an instance of Apc from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Apc.parse_obj(obj)
