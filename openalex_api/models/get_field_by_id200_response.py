...
class GetFieldById200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFieldById200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFieldById200Response:
        """Create an instance of GetFieldById200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFieldById200Response.parse_obj(obj)

        _obj = GetFieldById200Response.parse_obj({
