...
class CountsByYearInner(BaseModel):
    ...
    __properties = ["cited_by_count", "works_count", "year"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CountsByYearInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CountsByYearInner:
        """Create an instance of CountsByYearInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CountsByYearInner.parse_obj(obj)

        _obj = CountsByYearInner.parse_obj({
