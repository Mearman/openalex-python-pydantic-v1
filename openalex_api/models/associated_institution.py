...
class AssociatedInstitution(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssociatedInstitution:
    ...
    def to_dict(self):
        ...
        if self.relationship is None and "relationship" in self.__fields_set__:
            _dict['relationship'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> AssociatedInstitution:
        """Create an instance of AssociatedInstitution from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssociatedInstitution.parse_obj(obj)

        _obj = AssociatedInstitution.parse_obj({
