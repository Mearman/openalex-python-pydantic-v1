...
class ConceptsResponseSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConceptsResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConceptsResponseSchema:
        """Create an instance of ConceptsResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConceptsResponseSchema.parse_obj(obj)

        _obj = ConceptsResponseSchema.parse_obj({
