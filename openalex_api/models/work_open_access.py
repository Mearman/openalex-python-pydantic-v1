...
class WorkOpenAccess(BaseModel):
    ...
    WorkOpenAccess
    """
    any_repository_has_fulltext: StrictBool = Field(...)
    is_oa: StrictBool = Field(...)
    oa_status: StrictStr = Field(...)
    oa_url: StrictStr = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkOpenAccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkOpenAccess:
        """Create an instance of WorkOpenAccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkOpenAccess.parse_obj(obj)

        _obj = WorkOpenAccess.parse_obj({
