...
class AuthorsResponseSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthorsResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthorsResponseSchema:
        """Create an instance of AuthorsResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthorsResponseSchema.parse_obj(obj)

        _obj = AuthorsResponseSchema.parse_obj({
