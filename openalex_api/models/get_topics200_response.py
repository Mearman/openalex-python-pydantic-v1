...
class GetTopics200Response(BaseModel):
    ...
    meta: GetTopics200ResponseMeta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTopics200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTopics200Response:
        """Create an instance of GetTopics200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTopics200Response.parse_obj(obj)

        _obj = GetTopics200Response.parse_obj({
