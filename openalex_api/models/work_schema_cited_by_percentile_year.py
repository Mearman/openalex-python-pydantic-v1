...
class WorkSchemaCitedByPercentileYear(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkSchemaCitedByPercentileYear:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkSchemaCitedByPercentileYear:
        """Create an instance of WorkSchemaCitedByPercentileYear from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkSchemaCitedByPercentileYear.parse_obj(obj)

        _obj = WorkSchemaCitedByPercentileYear.parse_obj({
            "max": obj.get("max"),
            "min": obj.get("min")
        })
        return _obj
