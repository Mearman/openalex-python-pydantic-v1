...
class GetDomainById200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDomainById200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDomainById200Response:
        """Create an instance of GetDomainById200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDomainById200Response.parse_obj(obj)

        _obj = GetDomainById200Response.parse_obj({
