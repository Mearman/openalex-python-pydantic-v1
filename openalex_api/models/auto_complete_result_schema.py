...
class AutoCompleteResultSchema(BaseModel):
    ...
    """
    meta: Meta = Field(...)
    results: conlist(AutoCompleteResultItem) = Field(...)
    __properties = ["meta", "results"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoCompleteResultSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoCompleteResultSchema:
        """Create an instance of AutoCompleteResultSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutoCompleteResultSchema.parse_obj(obj)

        _obj = AutoCompleteResultSchema.parse_obj({
            "meta": Meta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "results": [AutoCompleteResultItem.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
