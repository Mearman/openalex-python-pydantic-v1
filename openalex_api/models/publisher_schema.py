...
class PublisherSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublisherSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublisherSchema:
        """Create an instance of PublisherSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublisherSchema.parse_obj(obj)

        _obj = PublisherSchema.parse_obj({
