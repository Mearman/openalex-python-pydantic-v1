...
class GetSubfieldById200Response(BaseModel):
    ...
    field: TopicLevelSchema = Field(...)
    id: Optional[Any] = Field(...)
    ids: Ids = Field(...)
    siblings: TopicLevelArraySchema = Field(...)
    topics: Optional[Any] = Field(...)
    updated_date: Optional[Any] = Field(...)
    works_api_url: Optional[Any] = Field(...)
    works_count: Optional[Any] = Field(...)
    __properties = ["cited_by_count", "created_date", "description", "display_name", "display_name_alternatives", "domain", "field", "id", "ids", "siblings", "topics", "updated_date", "works_api_url", "works_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSubfieldById200Response:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.topics is None and "topics" in self.__fields_set__:
            _dict['topics'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSubfieldById200Response:
        """Create an instance of GetSubfieldById200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSubfieldById200Response.parse_obj(obj)

        _obj = GetSubfieldById200Response.parse_obj({
