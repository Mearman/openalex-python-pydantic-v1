...
class GetTopics200ResponseMeta(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTopics200ResponseMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTopics200ResponseMeta:
        """Create an instance of GetTopics200ResponseMeta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTopics200ResponseMeta.parse_obj(obj)

        _obj = GetTopics200ResponseMeta.parse_obj({
            "count": obj.get("count"),
