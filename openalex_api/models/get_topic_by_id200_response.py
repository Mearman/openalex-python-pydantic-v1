...
class GetTopicById200Response(BaseModel):
    ...
    domain: TopicLevelArraySchema = Field(...)
    field: TopicLevelArraySchema = Field(...)
    id: Optional[Any] = Field(...)
    ids: Ids = Field(...)
    keywords: Optional[Any] = Field(...)
    siblings: TopicLevelSchema = Field(...)
    subfield: TopicLevelArraySchema = Field(...)
    updated_date: Optional[Any] = Field(...)
    works_count: Optional[Any] = Field(...)
    __properties = ["cited_by_count", "created_date", "description", "display_name", "domain", "field", "id", "ids", "keywords", "siblings", "subfield", "updated_date", "works_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTopicById200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTopicById200Response:
        """Create an instance of GetTopicById200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTopicById200Response.parse_obj(obj)

        _obj = GetTopicById200Response.parse_obj({
