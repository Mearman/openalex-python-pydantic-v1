...
class WorksResponseSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorksResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorksResponseSchema:
        """Create an instance of WorksResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorksResponseSchema.parse_obj(obj)

        _obj = WorksResponseSchema.parse_obj({
