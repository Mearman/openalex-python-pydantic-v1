...
class FunderSchema(BaseModel):
    ...
    FunderSchema
    """
    alternate_titles: Optional[Any] = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FunderSchema:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.grants_count is None and "grants_count" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.relevance_score is None and "relevance_score" in self.__fields_set__:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FunderSchema:
        """Create an instance of FunderSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FunderSchema.parse_obj(obj)

        _obj = FunderSchema.parse_obj({
