...
class TopicsResultsInner(BaseModel):
    ...
    field: Optional[TopicLevelSchema] = None
    id: StrictStr = Field(...)
    ...
    __properties = ["cited_by_count", "created_date", "description", "display_name", "domain", "field", "id", "ids", "keywords", "relevance_score", "siblings", "subfield", "updated_date", "works_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TopicsResultsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TopicsResultsInner:
        """Create an instance of TopicsResultsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TopicsResultsInner.parse_obj(obj)

        _obj = TopicsResultsInner.parse_obj({
            ...
            "subfield": TopicLevelSchema.from_dict(obj.get("subfield")) if obj.get("subfield") is not None else None,
