...
class InstitutionsResponseSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstitutionsResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstitutionsResponseSchema:
        """Create an instance of InstitutionsResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstitutionsResponseSchema.parse_obj(obj)

        _obj = InstitutionsResponseSchema.parse_obj({
