...
class PersonResponseSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonResponseSchema:
        """Create an instance of PersonResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonResponseSchema.parse_obj(obj)

        _obj = PersonResponseSchema.parse_obj({
