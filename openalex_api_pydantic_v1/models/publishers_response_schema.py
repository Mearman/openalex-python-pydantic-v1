...
class PublishersResponseSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublishersResponseSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublishersResponseSchema:
        """Create an instance of PublishersResponseSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublishersResponseSchema.parse_obj(obj)

        _obj = PublishersResponseSchema.parse_obj({
