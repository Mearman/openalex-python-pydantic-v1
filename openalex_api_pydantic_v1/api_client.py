...
import openalex_api_pydantic_v1.models
from openalex_api_pydantic_v1 import rest
from openalex_api_pydantic_v1.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(openalex_api_pydantic_v1.models, klass)
